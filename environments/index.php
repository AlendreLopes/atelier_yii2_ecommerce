...
return [
    'Development' => [
        ...
        'setWritable' => [
            ...
            'backend_moisson/runtime',
            'backend_moisson/web/assets',
            'console/runtime',
            ...
            'frontend_moisson/runtime',
            'frontend_moisson/web/assets',
        ],
        'setExecutable' => [
            'yii',
            'yii_test',
        ...
        'setCookieValidationKey' => [
            ...
            'backend_moisson/config/main-local.php',
            ...
            'frontend_moisson/config/main-local.php',
        ],
    ],
    'Production' => [
        'path' => 'prod',
